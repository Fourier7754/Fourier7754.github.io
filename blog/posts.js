...
window.POSTS = [
  ...
  {
    slug: "qwen-38-max-top-on-qoder",
    title: "Qwen 3.8 Max Tops the Qoder Harness Round on LiveCuratorBench",
    date: "2026-08-10",
    excerpt: "On LiveCuratorBench's Qoder harness round, Qwen 3.8 Max scores 18.67/22—first in the six-model field, ahead of a three-way tie at 18.00—with its edge concentrated in two rubric items no other model held across all three runs.",
    category: "Benchmark",
    tags: ["agents", "evaluation", "memory", "meta-knowledge", "qoder"]
  },
  {
    slug: "live-curator-benchmark-qoder",
    title: "LiveCuratorBench on the Qoder Harness: Six More Models",
    date: "2026-08-10",
    excerpt: "Six models reran LiveCuratorBench on the Qoder CLI harness: charted one entry per model at its stronger harness, with a separate pairing view for the four models tested on both, the same model can swing by up to 2.7 points across harnesses. Qwen 3.8 Max leads the Qoder round at 18.67/22; DeepSeek v4 Flash is the best value on either harness.",
    category: "Benchmark",
    tags: ["agents", "evaluation", "memory", "meta-knowledge", "qoder"]
  },
  {
